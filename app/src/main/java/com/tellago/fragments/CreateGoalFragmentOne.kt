 ...
 * Use the [CreateGoalFragmentOne.newInstance] factory method to
 * create an instance of this fragment.
 */
class CreateGoalFragmentOne : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_create_goal_one, container, false)
        communicator = activity as CreateGoalCommunicator

        view.btn_FragmentOne.setOnClickListener {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateGoalFragmentOne.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateGoalFragmentOne().apply {
